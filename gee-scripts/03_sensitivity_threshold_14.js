...
// Script 3: Sensitivity Testing — Threshold -14 dB
// Orbit: 114 ASCENDING | Time range: 2015-2025 | Threshold: -14 dB
...
Map.addLayer(frequencyRaster, {min: 0, max: 11, palette: ['white', 'lightblue', 'blue', 'darkblue']}, 'Surface Water Frequency t14');

print('Frequency raster t14:', frequencyRaster);

// Export frequency raster to Google Drive
Export.image.toDrive({
  image: frequencyRaster,
  description: 'barisal_surface_water_frequency_2015_2025_t14',
  folder: 'project2_barisal',
  fileNamePrefix: 'barisal_swf_2015_2025_t14',
